...
public class ParentViewHolder extends BaseViewHolder {
    ...
    public void bindView(final DataBean dataBean, final int pos, final ItemClickListener listener,OnItemClick onItemClick){
        ...
        containerLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (listener != null){
                    onItemClick.onItem(dataBean.getParentRightTxt());
                }
