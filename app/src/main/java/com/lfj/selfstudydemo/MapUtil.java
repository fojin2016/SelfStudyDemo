...
import com.lfj.selfstudydemo.bean.LatLng;
...
//            slon = originLatLng.longitude;
    ...
    public static void openGoogleMap(Context context, double slat, double slon, String sname, double dlat, double dlon, String dname) {
        String uriString = null;
